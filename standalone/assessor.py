...
from .journal_benchmark import JournalBenchmarkProfile, ingest_sample_papers
from .harness import (
...
class RunOptions:
    ...
    sample_papers_dir: Path | str | None = None
    sample_relevance_override: bool = False
...
def analyze_manuscript(options: RunOptions, *, event_sink: EventSink | None = None) -> AnalysisResult:
    ...
    try:
        ...
        if options.mode == "journal_benchmark" and options.sample_papers_dir:
            try:
                benchmark_profile = ingest_sample_papers(
                    options.sample_papers_dir,
                    target_journal_name=options.target_journal_name,
                    target_journal_scope=options.target_journal_scope,
                )
            except Exception:
                benchmark_profile = None

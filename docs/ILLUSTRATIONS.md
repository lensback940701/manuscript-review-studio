...
| 4 | `docs/images/04-closure-card.png` | 4:3 | Present a clean example of the concise public Closure Card. |

The exact slot markers remain in both landing pages so future image-only updates can be checked deterministically. Any replacement must update both language pages, preserve accessible alt text, and pass the release documentation tests.
